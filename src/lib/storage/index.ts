...
export const saveSessions = (sessions: SessionRecord[]) => sessionsRepo.saveAll(sessions);
...
export const saveMatches = (matches: MatchRecord[]) => matchesRepo.saveAll(matches);
